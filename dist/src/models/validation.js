...
function validateInquiryInput(data) {
    ...
    // Vehicle ID validation: Must be non-negative (0 for general contact, positive for vehicle inquiries)
    if (data.vehicleId === undefined || data.vehicleId === null || data.vehicleId < 0) {
        errors.push({
            field: 'vehicleId',
